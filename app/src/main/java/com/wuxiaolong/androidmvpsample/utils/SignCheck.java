...
/**
 * 使用方法：
 * if (!BuildConfig.DEBUG&&!new SignCheck(this,getResources().getString(R.string.key_sha1)).check()){
 *   Toast.makeText(getApplicationContext(), "您的应用程序已被重打包，请重新下载官方的正版安装包", Toast.LENGTH_LONG).show();
